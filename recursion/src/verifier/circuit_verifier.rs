...
#[derive(Clone)]
pub struct FriProofWires<F: Field, const D: usize, Comm: CommitRecursiveVerif, InputProof> {
...
#[derive(Clone)]
pub struct ProofWires<F: Field, const D: usize, Comm: CommitRecursiveVerif, InputProof> {
